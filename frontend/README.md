...
The frontend is configured to connect to the Java Spring Boot backend API at `http://localhost:8080`. Make sure the backend server is running before starting the frontend application.
